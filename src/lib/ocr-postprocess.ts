...
const ARABIC_MALE_NAMES = [
  ...
  "تامر", "غالب", "نديم",
  // Task 19-c — additional Gulf male names (KSA, UAE, Kuwait, Qatar, Bahrain, Oman, Yemen)
  "جامع", "مبارك", "حمدان", "خليفة", "مكتوم", "خميس", "ثاني", "مهنا", "شهوان",
  "عساف", "حمد", "مطلق", "عسكر", "سدير", "رمحان", "سحيم", "ناهض", "محيسن", "حميد",
  "سالم", "سلطان", "عبدالكريم", "عبدالرحيم", "فلاح", "درويش", "حارث", "حمدان",
  "رواد", "خليفة", "متعب", "متروك", "فهيد", "هزاع", "مرزوق", "مشعان", "هديب",
  "هلالي", "رشيد", "رميحي", "حجيلي", "صبيح", "عمران", "عزوز", "عمار", "مزعل",
  "مقبل", "مزروعي", "نوفان", "هزاني", "بركات", "بندر", "تركي", "جازع", "حارثي",
  "حسنان", "خلف", "خليوي", "دحمي", "راضي", "سعدون", "شطي", "شيبان", "ضيف الله",
  "عابس", "عبدالإله", "عتري", "عتابي", "عليوي", "عمران", "عواد", "فيحان", "قحطان",
  "قذان", "كتوعي", "مبخوت", "ناهي", "هتلوع", "هوساوي", "وادع",
  // Task 19-c — additional Levantine male names (Palestine, Jordan, Lebanon, Syria)
  "أنيس", "جبر", "محيي", "نبوي", "فكري", "إيهاب", "عزالدين", "عزالرحمن", "جودت",
  "بهاء", "بشير", "بطرس", "جاك", "جورج", "خاطر", "رضوان", "سميح", "صبحي",
  "عبدالمسيح", "ناهض", "نظير", "يوحنا", "خليل", "ياسر",
  // Task 19-c — additional Egyptian male names
  "العشيري", "الشافعي", "الجمل", "البدوي", "الصعيدي", "الشرقاوي", "أبوالمعارف",
  "الديب", "السقا", "الشاعر", "الصاوي", "العشماوي", "العماوي", "الفقي", "النحال",
  "بدوي", "صعيدي", "شرقاوي", "إمام", "شاعر", "فقي", "نحال", "مصيلحة", "مكاوي",
  "منشاوي", "منياوي", "بدراوي", "بلبيسي", "بسيوني", "بناني", "جرجاوي", "دمنهوري",
  "رشيدي", "سلفي", "سمنودي", "سوهاجي", "سنهوري", "شروياتي", "طنطاوي", "طوخي",
  "عاشور", "عماوي", "غردقاوي", "فيومي", "قناوي", "محلائي", "مطروحي", "مرساوي",
  "منصوري", "نخيلي", "نجعاوي", "واحاتي", "وثايقي", "يوسفي",
  // Task 19-c — additional Maghreb male names (Morocco, Algeria, Tunisia, Libya)
  "حسني", "إدريس", "علوي", "مرابط", "زياني", "تازي", "سراج", "العربي", "بريك",
  "اليعقوبي", "التازي", "البريهي", "الزليطني", "الونشريفي", "اليوسفي", "الراشدي",
  "العقوني", "العوني", "الغزواني", "القادري", "الكلاوي", "المغاري", "المرابطي",
  "بوسلام", "بلقاسم", "بنعمر", "بنعيسى", "بنعلي", "بوزيد", "زروال", "زرقاوي",
  "بوكروح", "بوزيان", "بوشريط", "بوسيف", "بولحسن", "بوحفص", "مغاري", "برناطي",
  "قادري", "بناني",
  // Task 19-c — additional Persian-origin male names
  "آرام", "آرش", "آصف", "آقا", "بيام", "پارسا", "پاشا", "پدرام", "پژمان", "پرویز",
  "تارا", "ترانه", "تیمور", "جاويد", "جمشيد", "جهاندار", "خسرو", "داريوش", "دنيز",
  "راد", "رامتين", "رستمی", "رها", "روناك", "زالي", "ساسان", "سروش", "سهراب",
  "سيروس", "شاهين", "شيرين", "فرهاد", "فرامرز", "فريدون", "كامران", "كاميار",
  "كوروش", "كیان", "كيان", "گشتاسب", "منوچهر", "مهراد", "نادر", "نويد", "نياز",
  "هرمز", "پانته", "پروشات", "پژواك", "آواک", "آونگ", "بنیامین", "بهنام",
  // Task 19-c — additional male Arabic names
  "أكرم", "إلياس", "بشير", "حنا", "داوود", "ساري", "عبدالمسيح", "كرم", "ميلاد",
  "نادر", "نزار", "هشام", "وحيد", "يوسف", "بهاء", "جودت", "حسني", "حفيظ", "رؤوف",
  "فكري", "نبوي", "شهوان", "عزير", "محيي", "عزالدين", "عزالرحمن", "جامع", "حمدان",
  "حمد", "مكتوم", "خميس", "ثاني", "مهنا", "عساف", "مطلق", "عسكر", "أنيس", "جبر",
  "إيهاب", "ساري", "علوي", "مرابط", "سراج", "العربي", "بريك", "اليعقوبي", "إدريس",
  "حسني", "تازي", "زياني",
];
...
const ARABIC_FEMALE_NAMES = [
  ...
  // Task 19-c — additional female Arabic names (Gulf + Levant + Maghreb + Egyptian)
  "دلال", "لورا", "إصيل", "ألين", "أمنية", "بيسان", "تالين", "تهاني", "جنان",
  "حصة", "خلود", "رؤى", "رابعة", "رزان", "رشا", "رفيف", "رواء", "رودينا",
  "روزانا", "ريما", "زاهية", "زبيدة", "زكية", "زهيرة", "زينة", "سارية", "سلمة",
  "سلسبيل", "سما", "سماح", "سامية", "سناء", "سهر", "سهام", "سوسن", "سيما",
  "شذا", "شذى", "شريفة", "شيرين", "صفا", "ضحى", "عبلة", "غالية", "غدير",
  "فاديا", "فدوى", "فرح", "فريدة", "فريال", "فيروز", "قمر", "قمرية", "كبرى",
  "كريمة", "لبنى", "لطيفة", "لميس", "ليان", "لين", "لينة", "مزنة", "ملك",
  "منة", "منال", "مها", "ميساء", "ميسون", "نائلة", "نبراس", "نجاة", "نجاح",
  "نجوى", "ندى", "نرمين", "نسرين", "نسمة", "نضال", "نعمة", "نوار", "نوران",
  "نيفين", "هدى", "هديل", "هيفاء", "وئام", "ولاء", "يارا", "يسرا",
  "آمنة", "أفراح", "ألهام", "إخلاص", "بيان", "جود", "حياة", "راما", "ريتا",
  "نجلاء", "رغد", "رنيم", "ماريتا", "ميرا", "ريم",
  // Task 19-c — additional Persian-origin female names
  "آناهيتا", "آذر", "آذري", "پريا", "تارا", "پروشات", "كیانا", "گل", "نرگس",
  "ترانه", "رها", "سارا", "پانته", "كيات",
  // Task 19-c — additional rare Arabic female names
  "أجواد", "أحواض", "أروان", "أطياف", "أفاف", "أفراد", "أفنان", "ألين", "أماني",
  "أمجاد", "أمل", "أمينة", "أناهيد", "أواه", "أيات", "آلاء", "آناء", "آية",
  "آمنة", "إباء", "إخلاص", "إسراء", "إصالة", "إعتدال", "إكرام", "إلينا", "إيمان",
  "إيناس", "أبرار", "أبتسام", "أحلام", "أسماء", "أسيل", "أطياف", "أفنان",
  "أفراح", "أفصام", "أقاليم", "أماني", "أمل", "أمينة", "أميرة", "أنجول",
  "أنوار", "أيهان", "أيهم", "بشائر", "بوران", "تالا", "تالة", "تالين",
  "تماضر", "توت", "جود", "جواهر", "جوسelyn", "حبيبة", "حسينية", "حصه",
  "خاشعة", "خلود", "خواطر", "دانة", "دعاء", "دنان", "دنيا", "ديمه", "راما",
  "ربى", "رتاج", "رتي", "رؤى", "روز", "رولا", "ريتاج", "ريتال", "زاهية",
  "زينب", "زينه", "سحر", "سديم", "شذا", "شهد", "شيماء", "ضحى", "ضياء",
  "عالية", "عبير", "عريس", "عفاف", "عهد", "غصون", "فجر", "فدوى", "فروق",
  "كوثر", "كومار", "لجين", "لمى", "لواحظ", "ليان", "ليلى", "ماريه",
  "مايا", "مروج", "مي", "ميرة", "نادين", "ناردين", "نبراس", "نجلاء",
  "نوال", "نيرة", "نيرين", "نيفين", "هالة", "هبة", "هدى", "ورود", "يارا",
];
...
const ARABIC_SURNAMES = [
  ...
  "مرسي", "بكري", "الحصري",
  // Task 19-c — additional Gulf surnames
  "الزعتري", "البيانوني", "الحدّاد", "الزيات", "النجار", "العطار", "الجزار",
  "الخراز", "الكواز", "الحلاق", "الفقي", "الشاعر", "الأديب", "الكاتب", "النقيب",
  "الطيار", "الحسام", "العش", "العدّاس", "الجندي", "الحلبي", "البيانوني",
  "الحمصي", "الدمشقي", "الطرابلسي", "الصيداوي", "البيروتي", "النابلسي",
  "الخليلي", "القدسي", "الجولاوي", "العاملي", "الهرري", "العشماوي", "البكري",
  "الصاوي", "الشافعي",
  // Task 19-c — additional Egyptian surnames
  "العشيري", "الشافعي", "الجمل", "البدوي", "الصعيدي", "الشرقاوي", "أبوالمعارف",
  "الديب", "السقا", "الصاوي", "العماوي", "الفقي", "النحال", "مصيلحة", "مكاوي",
  "منشاوي", "منياوي", "بدراوي", "بلبيسي", "بسيوني", "بناني", "جرجاوي",
  "دمنهوري", "رشيدي", "سمنودي", "سوهاجي", "سنهوري", "شروياتي", "طنطاوي",
  "طوخي", "عاشور", "غردقاوي", "فيومي", "قناوي", "محلائي", "مطروحي", "مرساوي",
  "نخيلي", "نجعاوي", "واحاتي", "وثايقي", "يوسفي",
  // Task 19-c — additional Maghreb surnames
  "الفاسي", "الإدريسي", "العلوي", "السباعي", "الوزاني", "الفهري", "التازي",
  "البريهي", "الزليطني", "الونشريفي", "اليوسفي", "الراشدي", "العقوني", "العوني",
  "الغزواني", "القادري", "الكلاوي", "المغاري", "المرابطي", "بوسلام", "بلقاسم",
  "بنعمر", "بنعيسى", "بنعلي", "بوزيد", "زروال", "زرقاوي", "بوكروح", "بوزيان",
  "بوشريط", "بوسيف", "بولحسن", "بوحفص", "مغاري", "برناطي", "قادري", "بناني",
  "العياشي", "العروسي", "العروصي",
  // Task 19-c — additional Persian-origin surnames
  "الرشدي", "البرناطي", "المهيزع", "الكواري", "الفهيد", "الحساني", "الجوهري",
];
...
const WESTERN_NAMES = [
  ...
  // Task 19-c — additional European male names (German, Italian, Spanish, French, Nordic, Slavic)
  "Erik", "Karl", "Francesco", "Henri", "Rudolf", "Wolfgang", "Klaus", "Heinz",
  "Gunter", "Johan", "Lukas", "Felix", "Julian", "Maximilian", "Matthias", "Stefan",
  "Vincenzo", "Pietro", "Luca", "Matteo", "Salvatore", "Vittorio", "Massimiliano",
  "Antonello", "Raffaele", "Pasquale", "Romeo", "Giancarlo", "Gianluca",
  "Alessandro", "Davide", "Lorenzo", "Giacomo", "Edoardo", "Cristian", "Michele",
  "Giorgio", "Marco", "Antonio", "Giuseppe", "Giovanni", "Sergio", "Massimo",
  "Roberto", "Francois", "Felipe", "Carlos", "Miguel", "Manuel", "Diego",
  "Alejandro", "Joaquin", "Hernan", "Thiago", "Bruno", "Mateo", "Santiago",
  "Tomas", "Pavel", "Piotr", "Nikolai", "Vladimir", "Dimitri", "Sergei",
  "Mikhail", "Igor", "Andrei", "Anders", "Bjorn", "Michel", "Philippe",
  "Andre", "Louis", "Franz", "Josef", "Lars", "Sven", "Hans",
  // Task 19-c — additional European female names
  "Marie", "Sophie", "Anne", "Margaret", "Clara", "Helga", "Astrid", "Nina",
  "Olga", "Tatiana", "Anastasia", "Irena", "Mila", "Nadia", "Lucia", "Beatrice",
  "Eva", "Lara", "Mia", "Lola", "Carmen", "Isabel", "Cristina", "Francesca",
  "Giovanna", "Sofia", "Lena", "Marta", "Elena", "Anna", "Julia",
  // Task 19-c — additional German surnames
  "Mueller", "Schmidt", "Schneider", "Fischer", "Weber", "Meyer", "Wagner",
  "Becker", "Hoffmann", "Schaefer", "Klein", "Wolf", "Adler", "Eggers",
  "Bach", "Braun", "Berg", "Berger", "Bauer", "Albrecht", "Bachmann",
  "Bartels", "Beck", "Bender", "Bergmann", "Brandt", "Busch", "Dietrich",
  // Task 19-c — additional Italian surnames
  "Rossi", "Ferrari", "Esposito", "Bianchi", "Romano", "Colombo", "Ricci",
  "Marino", "Greco", "Bruno", "Conti", "De Luca", "Costa", "Gallo", "Lombardi",
  "Moretti", "Barbieri", "Fontana", "Santoro", "Marra", "Caruso", "Russo",
  "Ferrara", "Monti", "Vitale", "Lombardo", "Marchetti", "Moretti", "Serra",
  // Task 19-c — additional Spanish / Latin surnames
  "Garcia", "Martinez", "Rodriguez", "Lopez", "Gonzalez", "Fernandez", "Sanchez",
  "Perez", "Gomez", "Ruiz", "Diaz", "Alvarez", "Moreno", "Muñoz", "Romero",
  "Alonso", "Gutierrez", "Navarro", "Torres", "Dominguez", "Vazquez", "Ramos",
  "Serrano", "Cruz", "Blanco", "Molina", "Mora", "Ortiz", "Delgado", "Castro",
  "Cabrera", "Herrera", "Pena", "Aguilar", "Carrasco", "Cortes", "Ibañez",
  "Mendez", "Vega", "Vidal", "Pascual", "Pozo", "Leon", "Marin", "Villegas",
  // Task 19-c — additional French surnames
  "Martin", "Bernard", "Dubois", "Thomas", "Robert", "Richard", "Petit", "Durand",
  "Leroy", "Moreau", "Simon", "Laurent", "Lefebvre", "Michel", "David", "Bertrand",
  "Roux", "Vincent", "Fournier", "Morel", "Girard", "André", "Lefevre", "Mercier",
  "Dumont", "Boyer", "Garnier", "Chevalier", "Legrand", "Gauthier", "Faure",
  "Renaud", "Henry", "Masson", "Marchand", "Mathieu", "Guillaume", "Rousseau",
  "Blanc", "Brun", "Bonnet", "Marchal", "Gaillard", "Barbier", "Boucher",
  "Perrin", "Fleury", "Roussel", "Chauvet", "Berger", "Hubert", "Lemoine",
  "Langlois",
  // Task 19-c — additional Russian / Eastern European surnames
  "Ivanov", "Petrov", "Sidorov", "Volkov", "Smirnov", "Kuznetsov", "Popov",
  "Vasiliev", "Mikhailov", "Fedorov", "Sokolov", "Lebedev", "Kozlov", "Novikov",
  "Morozov", "Volkova", "Ivanova", "Petrova", "Mikhailova", "Fedorova",
  // Task 19-c — additional Korean / Japanese / Chinese surnames (Latinized)
  "Kim", "Lee", "Park", "Choi", "Jung", "Kang", "Cho", "Yoon", "Lim", "Han",
  "Suzuki", "Sato", "Takahashi", "Tanaka", "Watanabe", "Ito", "Yamamoto",
  "Nakamura", "Kobayashi", "Saito", "Wang", "Li", "Zhang", "Liu", "Chen",
  "Yang", "Huang", "Zhao", "Wu", "Zhou", "Sun", "Ma", "Zhu", "Hu", "Guo",
  "Lin", "Luo", "Gao", "Zheng", "Chu",
  // Task 19-c — additional Vietnamese names (Latinized)
  "Nguyen", "Tran", "Le", "Pham", "Hoang", "Phan", "Vu", "Dang", "Bui", "Do",
  "Ho", "Ngo", "Duong", "Ly", "Truong", "Vuong", "Dao", "Dinh", "Doan", "Lam",
  "Trinh", "Vien", "To",
  // Task 19-c — additional Arabic-origin English surnames (Lebanese / Syrian / Egyptian / Palestinian diaspora)
  "Haddad", "Khoury", "Mansour", "Najjar", "Salama", "Shaheen", "Tahan", "Younis",
  "Saadeh", "Sayegh", "Saliba", "Massad", "Makdessi", "Karaki", "Khalife", "Harb",
  "Aoun", "Maalouf", "Sfeir", "Geagea", "Nader", "Rahme", "Ghanem", "Sader", "Saidi",
  "Husseini", "Moussa", "Nasser", "Hassan", "Hussein", "Saleh", "Salem", "Yousef",
  "El-Sayed", "ElSayed", "Ghonem", "Ghanem", "Abbas", "Tawfik", "Tawfiq", "Zaki",
  "Zakaria", "Abdullah", "Abdallah", "Abdul", "Abd El-Rahman", "Abdelrahman",
  "Abdulrahman", "Abdulaziz", "Abdulkareem", "Abdul Kareem", "Abdulhamid",
  "Abd El-Hamid", "Shalan",
  // Task 19-c — additional African (Ghanaian / Nigerian) surnames
  "Mensah", "Owusu", "Boateng", "Appiah", "Asante", "Acheampong", "Annan", "Adjei",
  "Frimpong", "Osei", "Adu", "Agyei", "Boakye", "Agyapong", "Okeke", "Eze",
  "Nwosu", "Okonkwo", "Okafor", "Nwankwo", "Okoro", "Bello", "Adeyemi", "Olawale",
  "Adebayo", "Ogunsanya", "Ogunleye", "Oyelaran", "Olanrewaju",
  // Task 19-c — additional American male names (less common)
  "Parker", "Quinn", "Reese", "Sawyer", "Brooks", "Hayes", "Hudson", "Mason",
  "Lincoln", "Wyatt", "Easton", "Hunter", "Colton", "Landon", "Jaxon", "Kayden",
  "Easton", "Brantley", "Kingston", "Maverick", "Zayden", "Bryson", "Karter",
  "Jaxson", "Caden", "Ayden", "Sylas",
  // Task 19-c — additional American female names (less common)
  "Avery", "Brianna", "Brooke", "Caroline", "Chloe", "Diana", "Ella", "Faith",
  "Grace", "Hannah", "Hailey", "Jada", "Kayla", "Kylie", "Leah", "Lily",
  "Madison", "Maya", "Naomi", "Natalie", "Olivia", "Paige", "Riley", "Savannah",
  "Stella", "Sydney", "Taylor", "Trinity", "Violet", "Willow", "Zoe", "Aria",
  "Aaliyah", "Aubrey", "Avery", "Bella", "Charlotte", "Ellie", "Emma", "Harper",
  "Ivy", "Layla", "Lily", "Luna", "Nora", "Penelope", "Quinn", "Riley", "Stella",
];
...
export const FIELD_LABEL_PATTERNS: Record<string, { label: string; lang: "ar" | "en" }[]> = {
  ...
  nationalId: [
    ...
    { label: "الرقم الوطني", lang: "ar" },
    { label: "البطاقة الوطنية", lang: "ar" },
    { label: "رقم البطاقة", lang: "ar" },
    { label: "رقم الهوية", lang: "ar" },
    { label: "الهوية", lang: "ar" },
    { label: "البطاقة", lang: "ar" },
    { label: "Citizen ID", lang: "en" },
    { label: "Identity Card No.", lang: "en" },
    { label: "Identity Card No", lang: "en" },
    { label: "Identity Card", lang: "en" },
    { label: "Identity Number", lang: "en" },
    { label: "Identity No", lang: "en" },
    { label: "National ID", lang: "en" },
    { label: "ID Number", lang: "en" },
    { label: "ID No", lang: "en" },
    { label: "ID Card No", lang: "en" },
    { label: "Personal ID", lang: "en" },
    { label: "Personal No", lang: "en" },
    { label: "Personal Number", lang: "en" },
    { label: "Personal Identification Number", lang: "en" },
  ],
  birthDate: [
  ...
  documentNo: [
    ...
    { label: "رقم الوثيقة الوطنية", lang: "ar" },
    { label: "الوثيقة", lang: "ar" },
    { label: "الجواز", lang: "ar" },
    { label: "Passport No.", lang: "en" },
    { label: "Passport No", lang: "en" },
    { label: "Passport Number", lang: "en" },
    { label: "Document No.", lang: "en" },
    { label: "Document No", lang: "en" },
    { label: "Document Number", lang: "en" },
    { label: "Doc No.", lang: "en" },
    { label: "Doc No", lang: "en" },
    { label: "Doc Number", lang: "en" },
    { label: "Passport ID", lang: "en" },
    { label: "Travel Document No", lang: "en" },
    { label: "Travel Document Number", lang: "en" },
  ],
  religion: [
...
export const OCR_CONFUSION_MAP: Record<string, string[]> = {
  ...
  // ── Task 19-c — additional Latin letter↔letter confusions ──
  "P": ["B", "R", "F"],
  "R": ["P", "K"],
  "F": ["P", "T"],
  "T": ["F", "I"],
  ...
  // ── Task 19-c — additional digit↔digit confusions ──
  "3": ["8", "5"],
  "7": ["1", "2"],

  // ── Task 19-c — Persian letter confusions (Persian Gulf OCR) ──
  "گ": ["ك", "ک"],
  "ک": ["ك", "گ"],
  "چ": ["ج"],
  "پ": ["ب"],
